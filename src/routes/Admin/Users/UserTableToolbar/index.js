      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          <Typography className={classes.title} color="inherit" variant="subtitle1" component="div">
            {numSelected}{' '}
            {numSelected > 1 ? (
              <IntlMessages id="users.appModule.selectedUsers" />
            ) : (
              <IntlMessages id="users.appModule.selectedUser" />
            )}
          </Typography>
        ) : (
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            {<IntlMessages id="users.appModule.users" />}{' '}
            <Button color="primary" onClick={() => onUserAdd(true)}>
              {<IntlMessages id="users.appModule.addNewUser" />}
            </Button>
          </Typography>
        )}
