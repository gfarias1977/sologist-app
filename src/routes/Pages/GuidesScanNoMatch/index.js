...
import {
  ...
  deleteGuide,
  setCurrentGuide,
  getScanedGuidesNoMatch,
  setInitStateGuide,
} from 'src/redux/actions/Guides';
...
import ExportButtonGuidesBeetrackNoMatch from 'src/components/ExportButtonGuidesBeetrackNoMatch';
...
const GuidesBeetrackModule = () => {
  ...
  useEffect(() => {
    if (guides.length > 0) {
      dispatch(
        getScanedGuidesNoMatch(selectedStartDate, selectedEndDate, filterOptions, debouncedSearchTerm, () => {
          ...
          <CardContent>
            <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems="center" mb={{ xs: 6, md: 5 }}>
              <GridContainer>
                ...
                <Box display="flex" justifyContent="flex-end" mb={4}>
                  <Box ml={2}>{guides && guides.length > 0 && <ExportButtonGuidesBeetrackNoMatch data={guides} />}</Box>
                </Box>
              </GridContainer>
            </Box>
          </CardContent>
