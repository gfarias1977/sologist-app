...
import { deleteBulkGuides } from 'src/redux/actions/Guides';
...
const filterOptionsList = [
  { label: <IntlMessages id="guides.appModule.filterRecibido" />, value: 'Recibido' },
  { label: <IntlMessages id="guides.appModule.filterPreparado" />, value: 'Preparado' },
  { label: <IntlMessages id="guides.appModule.filterDespachado" />, value: 'Despachado' },
  { label: <IntlMessages id="guides.appModule.filterEntregado" />, value: 'Entregado' },
  { label: <IntlMessages id="guides.appModule.filterDevuelto" />, value: 'Devuelto' },
  { label: <IntlMessages id="guides.appModule.filterCancelado" />, value: 'Cancelado' },
];
...
const GuideTableToolbar = ({
  ...
  const handleConfirmDelete = () => {
    ...
    dispatch(deleteBulkGuides(selected, () => setSelected([])));
  };
      ...
      <Toolbar
        ...
        {numSelected > 0 ? (
          ...
          <Typography className={classes.title} variant="h4" id="tableTitle" component="div">
            ...
            <Button color="primary" onClick={() => onGuideAdd(true)}>
              {<IntlMessages id="guides.appModule.addNewGuide" />}
            </Button>
          </Typography>
        )}
        ...
        {numSelected > 0 ? (
          ...
          <React.Fragment>
            ...
            <Tooltip title={<IntlMessages id="guides.appModule.filterList" />}>
